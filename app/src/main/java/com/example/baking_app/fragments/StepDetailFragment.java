...
public class StepDetailFragment extends Fragment implements ExoPlayer.EventListener {
    @BindView(R.id.fragment_step_description) TextView mStepDescriptionTextView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mStepDescriptionTextView.setText(mItem.getDescription());
        ...
        if (videoUrl.length() > 0 || thumbnailURL.length() > 0) {
            ...
            mPlayerView.setDefaultArtwork(BitmapFactory.decodeResource
                    (getResources(), R.drawable.video_play_active));
            ...
            if(thumbnailURL.length() > 0) {
                initializePlayer(Uri.parse(mItem.getThumbnailURL()));
            }
    ...
    private void initializePlayer(Uri mediaUri) {
        if (mExoPlayer == null) {
            ...
            String userAgent = Util.getUserAgent(getContext(), "Backing_App");
